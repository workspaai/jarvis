...
AGENT_SYSTEM_PROMPT = (
    ...
    "2. Po każdym wyszukiwaniu OCEŃ TREŚĆ fragmentów dwustopniowo: czy "
    "odpowiadają WPROST, a jeśli nie — czy odpowiedź WYNIKA z zawartej w nich "
    "reguły, limitu lub terminu? Fragment podobny tematycznie, bez żadnego "
    "z tych dwóch, NIE jest odpowiedzią.\n"
    ...
    "nie zawierają odpowiedzi ANI WPROST, ANI PRZEZ WYNIKANIE — wtedy piszesz "
    "wprost, że nie ma tego w dokumentach. Odpowiedź częściowa, warunkowa "
    "(np. 'wymaga zgody dyrektora') albo wynikająca z reguły (np. reguła "
    "'zgłoszenia do 14 dni od zakupu' odpowiada na pytanie 'czy po miesiącu "
    "mogę jeszcze zgłosić') to JEST odpowiedź — podaj ją z zastrzeżeniem "
    "i wskaż podstawę. Test przed odmową: jeśli w uzasadnieniu odmowy "
    "wskazałbyś regułę, z której odpowiedź wynika — podaj ją jako odpowiedź, "
    "nie odmawiaj. Zmyślaniem jest tylko twierdzenie bez oparcia we "
    "fragmentach; nigdy nie zmyślasz.\n"
